...
var commonErrors = [ 'error', 'failed', 'fatal', 'unable', 'wrong' ];
...
var start = function() {
  ...
  ssh.stderr.on('data', function (data) {
    error( 'Oh. Something went wrong. Error code is: ' + code.toString(), true );
  });
  
  ssh.on('close', function (code) {
    error( 'SSH exited prematurely with code ' + code.toString(), true );
  });
}
